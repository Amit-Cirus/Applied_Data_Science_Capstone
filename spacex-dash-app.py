...
sites_values = spacex_df['Launch Site'].unique().tolist()
...
options=[{'label': 'All Sites', 'value': 'ALL'},
        {'label': 'site1', 'value': sites_values[0]},
        {'label': 'site2', 'value': sites_values[1]},
        {'label': 'site3', 'value': sites_values[2]},
        {'label': 'site4', 'value': sites_values[3]},
        ]
...
def update_scatter_chart(entered_site, payload_range):
    low, high = payload_range  # Unpack selected payload range
